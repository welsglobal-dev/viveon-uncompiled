...
aside {
    position: fixed;
    top: var(--app-header-height, 64px); /* header safe */
    left: 0;
...
/* Prevent sidebar content from pushing layout */
.sidebar-top-banner,
